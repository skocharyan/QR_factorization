###########################################################################
## Makefile generated for component 'QR0'. 
## 
## Makefile     : QR0.mk
## Generated on : Tue Nov 21 14:00:40 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/QR0.exe
...
START_DIR                 = E:/Projects/Matlab/Beamformer/LCMV_Simulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = QR0_comp.rsp
CMD_FILE                  = QR0.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/QR0.exe
...
DEFINES_STANDARD = -DMODEL=QR0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/QR0_grt_rtw/QR0.c
...
%.obj : $(START_DIR)/QR0_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/QR0_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/QR0_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/QR0_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/QR0_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
QR0.obj : $(START_DIR)/QR0_grt_rtw/QR0.c
	$(CC) $(CFLAGS) -o "$@" "$<"
